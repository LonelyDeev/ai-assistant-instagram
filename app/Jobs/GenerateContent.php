...
class GenerateContent implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $contents = Content::where('status', 'waiting')->orWhere('images_status', 'generate')->get();
        foreach ($contents as $content) {
            ...
            } elseif ($content->tools_slug == "ai-images") {
                if ($content->image_prompt and $content->images_status == "waiting") {
